 export default {
  ...
  'navigation.ticket': 'Báo cáo sai phạm',
  ...
  'shop.form.description.placeholder': 'Bạn sẽ bán hoặc cung cấp dịch vụ gì?',
  ...
  'fields.note': 'Ghi chú',
  'shop.opening.request.successful': 'Bạn đã đăng ký mở shop với thông tin dưới đây:',
  ...
  'common.form.validation.shopPhone.number': 'Số điện thoại shop phải là số',
   'common.form.validation.shopPhone.valid': 'Hãy điền số điện thoại hợp lệ',
  'shop.form.validation.shopName.required': 'Hãy điền tên shop',
  'shop.form.validation.shopName.maxLength': 'Độ dài tên shop phải nhỏ hơn 255 kí tự',
  'shop.form.validation.description.required': 'Hãy điền miêu tả shop',
  'shop.form.validation.description.maxLength': 'Độ dài miêu tả shop phải nhỏ hơn 255 kí tự',
  'shop.form.validation.address.required': 'Hãy điền địa chỉ shop',
   'shop.form.validation.address.maxLength': 'Độ dài địa chỉ shop phải nhỏ hơn 255 kí tự',
  ...
  'shopReviews.shopAddress': 'Địa chỉ',
  'shopReviews.input': 'Đánh giá (tuỳ chọn)',
  'shopReviews.charactersLeft': 'kí tự còn lại',
  ...
  'shop.updateInformation': 'Sửa thông tin shop',
  'shop.information.updated': 'Thông tin shop đã được cập nhật',
  'shop.information.description': 'Miêu tả',
  'shop.information.publishStatus': 'Công khai',
  ...
  'error.review.you_must_order_at_this_shop_at_least_one_time': 'Để viết nhận xét, bạn cần phải đã từng đặt hàng tại shop này.',
  ...
  'blockMyTicket.modalViewTicket.button.closeTicket': 'Đóng báo cáo',
  ...
  'switchLanguage.title': 'Lựa chọn ngôn ngữ',
  ...
  'admin.async.error.unknownUpload': 'Định dạng tệp không được hỗ trợ',
  ...
  'admin.form.changePassword.oldPassword.blank': 'Mật khẩu cũ không được để trống',
  'admin.form.changePassword.newPassword.blank': 'Mật khẩu mới không được để trống',
  'admin.form.changePassword.newPassword.short': 'Mật khẩu mới không được ngắn hơn 8 kí tự',
  'admin.form.changePassword.repeatPassword.blank': 'Xác nhận mật khẩu mới không được để trống',
  'admin.form.changePassword.repeatPassword.doesNotMatch': 'Xác nhận mật khẩu không trùng khớp với mật khẩu mới',
  'admin.async.success.updateShopAvatar': 'Cập nhật ảnh đại diện shop thành công',
  'admin.async.success.updateShopCover': 'Cập nhật ảnh bìa shop thành công',
  'admin.async.success.banShop': 'Shop đã bị cấm.',
  'admin.async.success.unbanShop': 'Shop đã được bỏ cấm.',
  'admin.form.editShopInformation.validation.name.blank': 'Tên shop không được để trống',
  'admin.form.editShopInformation.validation.address.blank': 'Địa chỉ shop không được để trống',
  'admin.form.editShopInformation.validation.description.blank': 'Miêu tả cửa hàng không được để trống',
  'admin.form.editShopInformation.validation.address.long': 'Địa chỉ cửa hàng không được phép dài hơn 255 kí tự',
  'admin.async.success.updateShopInformation': 'Cập nhật thông tin shop thành công',
  'admin.async.success.updateShopShipPlace': 'Cập nhật thông tin vận hành của shop thành công',
  'admin.async.success.createPromotionSuccess': 'Chiến dịch quảng bá shop được tạo thành công',
  'admin.async.success.banUser': 'Người dùng đã bị cấm thành công',
  'admin.async.success.unbanUser': 'Người dùng đã được giải phóng thành công',
  'admin.async.success.updateUserInformation': 'Thông tin người dùng đã được lưu',
  'admin.form.userInformation.email.blank': 'Email không được để trống',
  'admin.form.userInformation.fullName.blank': 'Tên người dùng không được để trống',
  'admin.form.userInformation.fullName.long': 'Tên người dùng không được vượt quá 50 kí tự',
  'admin.form.userInformation.identityNumber.blank': 'Số chứng minh thư không được để trống',
  'admin.form.userInformation.identityNumber.isNaN': 'Số chứng minh thư chỉ bao gồm chữ số',
  'admin.form.userInformation.identityNumber.length': 'Số chứng minh thư phải bao gồm 9 hoặc 12 chữ số',
  'admin.form.userInformation.phone.isNaN': 'Số điện thoại chỉ bao gồm chữ số',
  'admin.form.userInformation.phone.blank': 'Số điện thoại không được để trống',
  'admin.async.success.updateRole': 'Cập nhật quyền hạn người dùng thành công',
  'admin.async.success.editPromotion': 'Cập nhật thông tin chiến dịch quảng bá thành công',
  'formChangeLanguage.sectionName': 'Thay đổi ngôn ngữ',
  ...
  'breadCrumb.dashBoard.description': 'Nơi mà các thông tin được tập trung',
  'breadCrumb.userManagement.description': ' ',
  'breadCrumb.userManagement.title': 'Quản lý người dùng',
  'breadCrumb.editUser.title': 'Thay đổi thông tin người dùng',
  'breadCrumb.editUser.description': 'Thay đổi thông tin, quyền hạn, cấm và bỏ cấm người dùng',
  'breadCrumb.shopManagement.title': 'Quản lý shop',
  'breadCrumb.shopManagement.description': 'Danh sách các shop',
  'breadCrumb.editShop.description': 'Thay đổi thông tin, thông tin vận hành, chiến dịch quảng bá, cấm, bỏ cấm shop',
  'breadCrumb.editShop.title': 'Thay đổi thông tin shop',
  'breadCrumb.ticketManagement.description': 'Danh sách các báo cáo sai phạm',
  'breadCrumb.ticketManagement.title': 'Quản lý báo cáo sai phạm',
  'breadCrumb.viewTicket.description': 'Thay đổi trạng thái báo cáo sai phạm, cùng với tin nhắn tới người dùng',
  'breadCrumb.viewTicket.title': 'Trả lời báo cáo sai phạm',
  'breadCrumb.requestManagement.description': 'Danh sách các yêu cầu của người dùng',
  'breadCrumb.requestManagement.title': 'Quản lý yêu cầu',
  'breadCrumb.viewRequest.title': 'Trả lời yêu cầu',
  'breadCrumb.viewRequest.description': 'Trả lời các yêu cầu của người dùng',
  'breadCrumb.promotionManagement.title': 'Quản lý chiến dịch quảng bá',
  'breadCrumb.promotionManagement.description': 'Danh sách các chiến dịch quảng bá shop',
  'breadCrumb.editPromotion.title': 'Thay đổi thông tin chiến dịch quảng bá',
  'breadCrumb.editPromotion.description': 'Thay đổi thông tin chiến dịch quảng bá của shop',
  ...
  'myOrder.openTicketModal.validation.message.long': 'Lời nhắn không thể dài hơn 65000 kí tự',
