export default {
  ...
  'admin.async.success.updateShopAvatar': 'Cập nhật ảnh đại diện cửa hàng thành công',
  'admin.async.success.updateShopCover': 'Cập nhật ảnh bìa cửa hàng thành công',
  'admin.async.success.banShop': 'Cửa hàng đã bị cấm thành công',
  'admin.async.success.unbanShop': 'Cửa hàng đã được thả',
  'admin.form.editShopInformation.validation.name.blank': 'Tên cửa hàng không được để trống',
  'admin.form.editShopInformation.validation.address.blank': 'Địa chỉ cửa hàng không được để trống',
  'admin.async.success.updateShopInformation': 'Cập nhật thông tin cửa hàng thành công',
  'admin.async.success.updateShopShipPlace': 'Cập nhật thông tin vận hành của cửa hàng thành công',
  'admin.async.success.createPromotionSuccess': 'Chiến dịch quảng bá cửa hàng được tạo thành công',
  ...
  'admin.form.userInformation.email.blank': 'Thư điện tử không được để trống',
  ...
  'breadCrumb.shopManagement.title': 'Quản lý cửa hàng',
  'breadCrumb.shopManagement.description': 'Danh sách các cửa hàng',
  'breadCrumb.editShop.description': 'Thay đổi thông tin, thông tin vận hành, chiến dịch quảng bá, cấm, bỏ cấm cửa hàng',
  'breadCrumb.editShop.title': 'Thay đổi thông tin cửa hàng',
  ...
  'breadCrumb.promotionManagement.description': 'Danh sách các chiến dịch quảng bá cửa hàng',
